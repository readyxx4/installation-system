...
CREATE TABLE `assignment` (
  ...
  KEY `tech_id` (`tech_id`),
  KEY `user_id` (`user_id`),
  KEY `idx_assignment_customer_id` (`customer_id`),
  ...
  CONSTRAINT `fk_assignment_customer_id` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`) ON UPDATE CASCADE
...
INSERT INTO `assignment` VALUES ('ASG-0000001','SET-0000025','TEC-2569-0002','USR-2569-0017','CUS-2569-0010','USR-2569-0009','2026-08-20 21:00:47','2026-08-28','09:00:00','18:00:00',1),('ASG-0000002','SET-0000027','TEC-2569-0002','USR-2569-0003','CUS-2569-0002','USR-2569-0009','2026-08-20 21:00:38','2026-08-31','16:00:00','18:00:00',1),('ASG-0000003','SET-0000029','TEC-2569-0002','USR-2569-0002','CUS-2569-0001','USR-2569-0009','2026-08-20 20:59:48','2026-08-31','09:00:00','12:00:00',1),('ASG-0000004','SET-0000028','TEC-2569-0002','USR-2569-0002','CUS-2569-0001','USR-2569-0009','2026-08-20 21:00:15','2026-08-31','13:00:00','15:00:00',1);
...
-- Dump completed on 2026-08-20 22:16:11
