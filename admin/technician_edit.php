...
<div class="staff-form-page">
  ...
  <form class="staff-create-card" method="POST" action="<?= h(app_system_url('admin/technician_edit.php')) ?>"
    autocomplete="off" id="techEditForm"
    data-duplicate-url="<?= h(app_system_url('admin/technician_edit.php')) ?>"
    data-current-tech-id="<?= h($technician['tech_id']) ?>"
    data-original-password="<?= h($technician['tech_password'] ?: '1234') ?>">
      ...
      <div class="staff-field">
        ...
        <div class="staff-input-wrap">
          ...
          <input type="text" id="tech_phone" name="tech_phone" maxlength="10" inputmode="numeric"
            value="<?= h($technician['tech_phone']) ?>" required>
        </div>
      ...
      <div class="staff-field">
        ...
        <div class="staff-input-wrap">
          ...
          <input type="email" id="tech_email" name="tech_email" maxlength="100"
            value="<?= h($technician['tech_email']) ?>" required>
        </div>
      ...
      <div class="staff-field staff-field-full">
        ...
        <div class="password-inline-row">
          <div class="staff-input-wrap password-input-wrap">
            <?= icon_svg('lock') ?>
            <input type="text" id="tech_password" name="tech_password"
              value="<?= h($technician['tech_password'] ?: '1234') ?>" readonly>
          </div>

          <button type="button" class="password-change-trigger" id="passwordTrigger">
            แก้รหัสผ่าน
          </button>
        </div>
      </div>
